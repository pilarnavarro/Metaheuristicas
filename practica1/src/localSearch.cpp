...
//-------------------------ESTRUCTUelementRA DE LA SOLUCION-------------------------
...
*/
void localSearch(const vector<vector<double> > &matriz, const unsigned int &num_sel, const int &seed){
    clock_t start, total;
    solucion sol;
    bool mejora;
...
int main(int argc, char *argv[]){
    ...
    localSearch(matriz,num_sel,seed);
}